...
> When connecting to your nodes plugin GUI as outlined in ['fund your node'](https://docs.goplugin.co/plugin-installations/fund-your-node), you must use '*_https_*://your_node_ip:*_6689_*' instead due to the configuration applied by the [main script](#main-script-actions)
